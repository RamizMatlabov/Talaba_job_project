...
const STRINGS: Record<Locale, Record<string, string>> = {
  uz: {
    ...
    "filters.salary.label": "Maosh",
    "filters.salary.any": "Farqi yo‘q",
    "filters.salary.lt3m": "3 mln gacha",
    "filters.salary.3to5m": "3–5 mln",
    "filters.salary.5to8m": "5–8 mln",
    "filters.salary.gte8m": "8 mln+",
    "filters.sort.label": "Saralash",
    "filters.sort.relevance": "Mosligi bo‘yicha",
    "filters.sort.salary_desc": "Maosh: yuqoridan",
    "filters.sort.salary_asc": "Maosh: pastdan",
    "filters.sort.title_asc": "Lavozim (A–Z)",
    "filters.sort.company_asc": "Kompaniya (A–Z)",
    "filters.remoteOnly": "Faqat masofaviy",
    ...
    "jobsListing.results": "Natijalar:",
    "jobsListing.page": "Sahifa",
    "jobsListing.of": "dan",
  ...
  en: {
    ...
    "filters.salary.label": "Salary",
    "filters.salary.any": "Any",
    "filters.salary.lt3m": "Up to 3M",
    "filters.salary.3to5m": "3–5M",
    "filters.salary.5to8m": "5–8M",
    "filters.salary.gte8m": "8M+",
    "filters.sort.label": "Sort",
    "filters.sort.relevance": "Relevance",
    "filters.sort.salary_desc": "Salary: high to low",
    "filters.sort.salary_asc": "Salary: low to high",
    "filters.sort.title_asc": "Title (A–Z)",
    "filters.sort.company_asc": "Company (A–Z)",
    ...
    "jobsListing.results": "Results:",
    "jobsListing.page": "Page",
    "jobsListing.of": "of",
  ...
  ru: {
    ...
    "filters.salary.label": "Зарплата",
    "filters.salary.any": "Любая",
    "filters.salary.lt3m": "До 3 млн",
    "filters.salary.3to5m": "3–5 млн",
    "filters.salary.5to8m": "5–8 млн",
    "filters.salary.gte8m": "8 млн+",
    "filters.sort.label": "Сортировка",
    "filters.sort.relevance": "По релевантности",
    "filters.sort.salary_desc": "Зарплата: по убыванию",
    "filters.sort.salary_asc": "Зарплата: по возрастанию",
    "filters.sort.title_asc": "Должность (A–Z)",
    "filters.sort.company_asc": "Компания (A–Z)",
    "filters.remoteOnly": "Только удалёнка",
    ...
    "jobsListing.results": "Результатов:",
    "jobsListing.page": "Страница",
    "jobsListing.of": "из",
